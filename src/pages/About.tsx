      ...
      <div className="max-w-4xl mx-auto px-4 space-y-8">
        ...
        <div className="bg-emerald-900 text-white rounded-3xl p-8 shadow-xl relative overflow-hidden border border-emerald-800">
          ...
          <div className="relative z-10 flex flex-col md:flex-row items-center gap-6">
            ...
            <div className="text-center md:text-right space-y-2">
              <h3 className="text-2xl font-bold font-serif">رفيق الحافظ v2.1</h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-right" dir="rtl">
          ...
          <section className="space-y-4">
            ...
            <p className="text-gray-600 leading-relaxed text-sm">
              يوفر التطبيق عداداً تفاعلياً للحفظ الجديد (مائة التكرار)، مما يشجع الحافظ على تكرار المقطع الجديد عدداً كافياً من المرات في يومه الأول لضمان جودة الحفظ من اللحظة الأولى.
            </p>
          </section>
        </div>
        ...
        <div className="bg-gray-50 rounded-3xl p-8 text-center space-y-4 border border-gray-100">
          ...
          <a href="https://rafiq-alhafiz-api-server.vercel.app/" className="inline-block text-emerald-700 font-bold hover:underline">rafiq-alhafiz-api-server.vercel.app</a>
        </div>
      </div>
    </div>
  );
